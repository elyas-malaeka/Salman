            ...
            <div class="header-content" style="padding-top: 200px;">
                <div class="glass-container">
                    ...
                    style=" font-size: 3.5rem;
                            ...
                            line-height: 1.1;" > <?php echo getTermsContent('header_title', $lang); ?>
                            </h1>
                    ...
                    <div class="col-lg-4">
                        <div class="registration-sidebar sticky-sidebar wow fadeInRight" data-wow-delay="200ms">
                                ...
                                <ul class="contact-list">
                                    <li>
                                        ...
                                        <div class="text">
                                            ...
                                            <a href="tel:<?php echo getConfigValue('contact_phone', '+97142824214'); ?>" class="contact-link">
                                                <?php echo formatPhone(getConfigValue('contact_phone', '+97142824214'), $lang); ?>
                                            </a>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="text">
                                            ...
                                            <a href="mailto:<?php echo getConfigValue('contact_email', 'info@salmanfarsi.ae'); ?>" class="contact-link">
                                                <?php echo getConfigValue('contact_email', 'info@salmanfarsi.ae'); ?>
                                            </a>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="text">
                                            ...
                                            <?php 
                                                ...
                                                if ($lang == 'en') {
                                                    echo getConfigValue('contact_address_en', 'Al Qusais, Dubai, United Arab Emirates');
                                                } else if ($lang == 'ar') {
                                                    echo getConfigValue('contact_address_ar', 'القصيص، دبي، الإمارات العربية المتحدة');
                                                } else {
                                                    echo getConfigValue('contact_address', 'القصیص، دبی، امارات متحده عربی');
                                                }
                                            ?>
                                            </p>
                                        </div>
                            ...
                            <div class="sidebar-widget important-dates">
                                ...
                                <ul class="dates-list">
                                    <?php
                                    // Get important dates from database or default values
                                    $importantDates = getTermsRepeatingItems('important_date', $lang);
                                    foreach ($importantDates as $date) {
                                        $dateData = json_decode($date, true);
                                        if ($dateData) {
                                            echo '<li>';
                                            // Add direction control for date text to prevent reverse display
                                            if ($lang == 'fa' || $lang == 'ar') {
                                                echo '<span class="date" dir="rtl">' . $dateData['date'] . '</span>';
                                                echo '<p dir="rtl">' . $dateData['description'] . '</p>';
                                            } else {
